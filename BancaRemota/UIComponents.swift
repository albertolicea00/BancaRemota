...
// MARK: - Tool List Row (full-width row with description, used in Herramientas)
struct ToolListRow: View {
    let iconName: String
    let title: String
    let description: String
    var themeColor: Color = .appPrimary
    let onTap: () -> Void
...
// MARK: - Document Picker (File Importer Wrapper)
...
struct DocumentPicker: UIViewControllerRepresentable {
    ...
    class Coordinator: NSObject, UIDocumentPickerDelegate {
        ...
        func documentPicker(_ controller: UIDocumentPickerViewController, didPickDocumentsAt urls: [URL]) {
            ...
            if url.startAccessingSecurityScopedResource() { onPick(url); url.stopAccessingSecurityScopedResource() }
        }
    }
}
