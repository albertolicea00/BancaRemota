        ...
        VStack(spacing: 0) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 25) {
                    ...
                    HelpSection(title: "Menú Moderno", content: "En Configuración → 'Tipo de Menú' puedes cambiar entre el menú Clásico (panel lateral) y el menú Moderno, que reemplaza el panel lateral por una barra de pestañas inferior con Favoritos, Bancos, Herramientas y Configuración.\n\nCon el menú Moderno activado, puedes además ocultar la pestaña de Bancos (sus operaciones pasan a Herramientas) y mostrar la Tasa de Cambio como una pestaña aparte en vez de dentro de Herramientas.")

                    HelpSection(title: "Color de Acento", content: "En Configuración → 'Apariencia' puedes activar 'Usar color de acento personalizado' y elegir cualquier color con el selector. Ese color se aplica al instante en toda la app: barra de pestañas del menú Moderno, menú lateral del Clásico, iconos, botones y tarjetas de Favoritos. Si desactivas la opción, la app vuelve al color por defecto.")
